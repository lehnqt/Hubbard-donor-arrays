function [S,Sm] = spindist(rc,N_size,N_fill,hopp,epsilon_up,epsilon_down,U,V0,r) 
...
fprintf('calculating ground state spin\n');
[~,N_up,N_down] = filgs2d_full(N_size,N_fill,t_up,t_down,epsilon_up,epsilon_down,U,V0,r);
S=N_up-N_down;
[~,N_up,N_down] = filgs2d_full(N_size,N_fill-1,t_up,t_down,epsilon_up,epsilon_down,U,V0,r);
Sm=N_up-N_down;
end